...
if (!function_exists('_icons')) {
    function _icons(string $icon_name = 'user', bool $all = false)
    {
        $icon_list = [
            ...
            'doctors' => 'bi bi-person-hearts',
            'email' => 'bi bi-envelope-at',
            'email_to' => 'bi bi-envelope-arrow-up',
            ...
            'fitness_certificates' => 'bi bi-book',
            'bars' => 'bi bi-grid',
            'globe' => 'bi bi-globe2',
            ...
            'issue_types' => 'bi bi-puzzle',
            'issue_summaries' => 'bi bi-sliders',
            'issue_summary_causes' => 'bi bi-suit-club',
            'industry_type' => 'bi bi-bank',
            'interactions' => 'bi bi-ui-radios-grid',
            ...
            'live_users' => 'bi bi-person-raised-hand',
