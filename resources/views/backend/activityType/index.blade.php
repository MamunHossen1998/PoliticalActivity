<x-master>
    ...
    <div class="container-fluid py-3">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <button class="btn btn-accent btn-sm" id="btnAddUser"
                data-url="{{ route('activityType.create', ['segment' => $segment]) }}">
        ...
        <div class="glass-card p-3">
            <div class="table-responsive">
                <table id="activityTypeList" class="table table-striped align-middle w-100">
                    <thead>
                        <tr>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const table = $('#activityTypeList').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('activityType.data', ['segment' => $segment]) }}',
                columns: [
                    {
                        data: 'sl',
                        name: 'Sl'
